 ...
 */
export const BuildURLToDocument = async (documentTitle: string, invoiceID: number): Promise<string> => {
    ...
    return `${await (await sp.web.get()).Url}/Lists/${encodeURI(MyLists["AR Invoice Requests"])}/Attachments/${invoiceID}//${encodeURI(documentTitle)}?web=1`;
};
